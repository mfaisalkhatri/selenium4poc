...
public class DeliverySelection {
    ...
    public String getDeliveryAddressName () {
        return getDriver().findElement(By.cssSelector("mat-card > div.addressCont > div:nth-child(2)")).getText();
    }

    public String getDeliveryAddress () {
        return getDriver().findElement(By.cssSelector("mat-card > div.addressCont > div:nth-child(3)")).getText();
    }

    public String getDeliveryAddressCountry () {
        return getDriver().findElement(By.cssSelector("mat-card > div.addressCont > div:nth-child(4)")).getText();
    }

    public String getDeliveryAddressPhoneNumber () {
        return getDriver().findElement(By.cssSelector("mat-card > div.addressCont > div:nth-child(5)")).getText();
    }
